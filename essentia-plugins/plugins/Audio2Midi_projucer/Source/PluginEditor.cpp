    ...
    , processorRef(p)
{
    ...
    frequencyGroupLabel.setFont(juce::Font(16.0f, juce::Font::bold));
    ...
    tuningGroupLabel.setFont(juce::Font(16.0f, juce::Font::bold));
    ...
    midiGroupLabel.setFont(juce::Font(16.0f, juce::Font::bold));
    ...
    systemGroupLabel.setFont(juce::Font(16.0f, juce::Font::bold));
    ...
    timeCompensationLabel.setFont(juce::Font(13.0f));
